...
import { CognitoIdentityProviderClient, AssociateSoftwareTokenCommand, SetUserMFAPreferenceCommand, VerifySoftwareTokenCommand, UserContextDataType, RespondToAuthChallengeCommand, ChallengeNameType, GetUserCommand } from "@aws-sdk/client-cognito-identity-provider";


export const associateSoftwareToken = async (accessToken?: string, session?: string): Promise<MFAAssociateResponse> => {
