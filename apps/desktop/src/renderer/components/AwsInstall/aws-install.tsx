...
export function AwsInstall({ accessKeyId, secretAccessKey }: Props) {
  ...
  async function installWallet(): Promise<InstallationResult> {
    try {
      ...
      enVars.AutoUpdate = autoUpdate;
      console.log('installing... envVars', enVars);
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
          ...
          <form onSubmit={install}>
            <FormControl fullWidth>
              <TextField
                ...
                value={email}
                helperText='You will receive an email with your temporary password and the
                URL of your Own Llavero. If this is an update use the same email
                as the installation.'
              ...
              <FormControlLabel
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                  setAutoUpdate(e.target.checked as boolean)
                }
              />
              <FormHelperText>
                Run AWS CodePipeline on each release.{' '}
                <Link
                  onClick={() =>
                    openBrowser(
              ...
              <TextField
                ...
                value={keysNumber}
                onChange={(e) => setKeysNumber(parseInt(e.target.value, 10))}
              />
              ...
              <Collapse in={showAdvanced}>
                ...
                <FormHelperText>AWS REGION </FormHelperText>
              </Collapse>
                ...
                >
                  <CardContent>
                    ...
                    <Typography variant='body2'>
                      You will get an email with your temporary password and the
                      URL of your Own Llavero in the next 20 minutes.
                    </Typography>
                  </CardContent>
                </Card>
              )}
              ...
              {installation === 'failed' && (
                <Card
                  sx={{ bgcolor: 'red', color: '#fff', marginBottom: '1rem' }}
                >
                  <CardContent>
                    <Typography variant='h5' component='div'>
